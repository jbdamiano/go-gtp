...
func (s *Session) WaitMessage(seq uint16, timeout time.Duration) (message.Message, error) {
	select {
...
func (t *teidMap) delete(ifType uint8) {
	t.syncMap.Delete(ifType)
}
